...
inline bool operator==(const PipelineStateCreateInfo& Lhs, const PipelineStateCreateInfo& Rhs)
{
    return false;
}

inline bool operator==(const GraphicsPipelineStateCreateInfo& Lhs, const GraphicsPipelineStateCreateInfo& Rhs)
{
    return false;
}
