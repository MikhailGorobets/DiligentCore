...
public:
    IArchiveBuilderFactory* GetArchiveFactory();

    DynamicLinearAllocator* GetMemoryAllocator();
...
private:
    static EngineEnvironment* m_pEnvironment;

private:
    RefCntAutoPtr<IArchiveBuilderFactory>   m_pArchiveBuilderFactory;
