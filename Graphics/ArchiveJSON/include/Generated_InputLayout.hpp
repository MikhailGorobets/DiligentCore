...
inline void to_json(nlohmann::json& Json, const InputLayoutDesc& Type)
{
    ...
    {
        to_json_ex(Json["LayoutElements"], Type.LayoutElements, Type.NumElements);
    }
...
inline void from_json(const nlohmann::json& Json, InputLayoutDesc& Type)
{
    ...
    {
        from_json_ex(Json["LayoutElements"], remove_const(&Type.LayoutElements), Json.at("NumElements"));
    }
