...
inline void to_json(nlohmann::json& Json, const ShaderDesc& Type)
{
    ...
    {
        Json["ShaderType"] = Type.ShaderType;
    }
}
...
inline void from_json(const nlohmann::json& Json, ShaderDesc& Type)
{
    ...
    {
        Json["ShaderType"].get_to(Type.ShaderType);
    }
}
...
inline void to_json(nlohmann::json& Json, const ShaderCreateInfo& Type)
{
    ...
    {
        to_json_ex(Json["ByteCode"], Type.ByteCode, Type.ByteCodeSize);
    }
    ...
    {
        to_json_ex(Json["Macros"], Type.Macros);
    }
...
inline void from_json(const nlohmann::json& Json, ShaderCreateInfo& Type)
{
    ...
    {
        from_json_ex(Json["ByteCode"], remove_const(&Type.ByteCode), Json.at("ByteCodeSize"));
    }
    ...
    {
        from_json_ex(Json["Macros"], remove_const(&Type.Macros));
    }
